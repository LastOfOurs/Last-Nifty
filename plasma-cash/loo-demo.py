...
print('Bob has {} LAST tokens'.format(bobTokensStart))
assert bobTokensStart == 0, "START: Bob has incorrect number of LAST tokens"
charlieTokensStart = charlie.token_contract.balance_of()
print('Charlie has {} LAST tokens'.format(charlieTokensStart))
assert charlieTokensStart == 0, "START: Charlie has incorrect number of LAST tokens"
